...
//#else
  ...
  * of creation of this object.
//#endif /* ASTROLOGY */
  * @param sd A SweDate object that might already be available at the time
  * of creation of this object.
...
//#endif /* ASTROLOGY */
    ...
    if (sd==null) { this.sd=new SweDate(); }
//#ifndef ASTROLOGY
...
//next_try:
    while (true) {
      ...
      if (dctr.val > Math.abs(rsminusrm)) {/* partial, no 2nd and 3rd contact */
        ...
        tret[2] -= sd.getDeltaT(tret[2]);
        tret[3] -= sd.getDeltaT(tret[3]);
      }
      /* contacts 1 and 4 */
      ...
      tret[1] -= sd.getDeltaT(tret[1]);
      tret[4] -= sd.getDeltaT(tret[4]);
      /*
...
//#endif /* TRACE0 */
    ...
    if (calc_flag == SweConst.SE_ECL2HOR) {
          tjd_et = tjd_ut + sd.getDeltaT(tjd_ut);
...
//#endif /* TRACE0 */
    return swe_pheno(tjd_ut + sd.getDeltaT(tjd_ut), ipl, iflag, attr, serr);
  }
//#endif /* ASTROLOGY */
...
//#endif /* TRACE0 */
    ...
    double tjd_et = tjd_ut + sd.getDeltaT(tjd_ut);
...
//#endif /* TRACE0 */
    return swe_nod_aps(tjd_ut + sd.getDeltaT(tjd_ut),
