...
//System.out.println(">>> "+res);
  ...
  private BigDecimal const2_52=new BigDecimal("2251799813685248"); // 0x8000000000000
  private BigDecimal const2=new BigDecimal("2");

  private String dblToString(double d, int prec) {
    long lng, exp, i, lMant;
    boolean nexp=false;
...
//
    ...
    lng=Double.doubleToLongBits(d);
    lMant=lng&0x000fffffffffffffL;
    exp =(lng&0x3ff0000000000000L) >> 52;
    nexp=(lng&0x4000000000000000L) == 0L;
