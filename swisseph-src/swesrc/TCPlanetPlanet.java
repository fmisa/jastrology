...
double minVal = 0., maxVal = 0.;  // Thinking about it...
  ...
  * SweConst.SE_VESTA with the exception of  SweConst.SE_EARTH.
  ...
  * the basic planet calculations, these are SweConst.SEFLG_TOPOCTR and
  * SweConst.SEFLG_SIDEREAL, plus the (optional) ephemeris flags
  * SweConst.SEFLG_MOSEPH, SweConst.SEFLG_SWIEPH or SweConst.SEFLG_JPLEPH.
  ...
  */
  public TCPlanetPlanet(SwissEph sw, int pl1, int pl2, int flags, double offset) {
    ...
    if (pl1<SweConst.SE_SUN ||
        pl1>SweConst.SE_VESTA ||
        pl1==SweConst.SE_EARTH ||
        pl2<SweConst.SE_SUN ||
        pl2>SweConst.SE_VESTA ||
