...
//#endif /* TRACE0 */
    ...
    g = SwephData.STR*(LP + MP - NF + 4.68);
    l += 0.49331 * Math.sin(g);
    g = SwephData.STR*(LP - MP - NF + 4.68);
    l += 0.4914 * Math.sin(g);
    g = SwephData.STR*(LP+NF+2.52);
    ...
    g = SwephData.STR*(LP - MP + 2.9);
    B +=  0.45587 * Math.sin(g);
    g = SwephData.STR*(LP + MP + 2.5);
    B +=  -0.41573 * Math.sin(g);
    g = SwephData.STR*(LP - 2.0*NF + 3.2);
    B +=  0.32623 * Math.sin(g);
    g = SwephData.STR*(LP - 2.0*D + 2.5);
...
//    pol[3] = swi_mod2PI((LP - MP) * SwephData.STR + SwephData.PI);
//    pol[4] = 0;
