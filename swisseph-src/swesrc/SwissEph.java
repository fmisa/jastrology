...
//#ifdef TRACE0
    Trace.level++;
    Trace.trace(Trace.level, "SwissEph(String)");
//#ifdef TRACE1
...
//#ifdef TRACE0
    Trace.level++;
    Trace.trace(Trace.level, "SwissEph.setHttpBufSize(int)");
//#ifdef TRACE1
...
//#ifdef TRACE0
    Trace.level++;
    Trace.trace(Trace.level, "SwissEph.swe_calc_ut(double, int, int, double[], StringBuffer)");
//#ifdef TRACE1
    System.out.println(System.currentTimeMillis()+" SwissEph.swe_calc_ut(double, int, int, double[], StringBuffer)");
    System.out.println("    tjd_ut: " + Trace.fmtDbl(tjd_ut) + "\n    ipl: " + ipl + "\n    iflag: " + iflag);
    Trace.printDblArr("xx", xx);
...
//#ifdef TRACE0
    Trace.level++;
    Trace.trace(Trace.level, "SwissEph.swe_calc(double, int, int, double[], StringBuffer)");
//#ifdef TRACE1
    System.out.println("    tjd: " + Trace.fmtDbl(tjd) + "\n    ipl: " + ipl + "\n    iflag: " + iflag);
    Trace.printDblArr("xx", xx);
    System.out.println("    serr: " + serr);
//#endif /* TRACE1 */
//#endif /* TRACE0 */
...
//#endif /* TRACE0 */
  ...
  // This is the new recommend interface for planetary calculations.
  // It might be rewritten to be used for fixstars as well.
...
//#ifdef TRACE0
    Trace.level++;
    Trace.trace(Trace.level, "SwissEph.swe_close()");
//#endif /* TRACE0 */
    int i;
    try {
...
//#ifdef TRACE0
    Trace.level++;
    Trace.trace(Trace.level, "SwissEph.swe_set_ephe_path(String)");
//#ifdef TRACE1
    System.out.println("    path: " + path);
//#endif /* TRACE1 */
//#endif /* TRACE0 */
...
//#ifdef TRACE0
    System.out.println(System.currentTimeMillis()+" SwissEph.swe_set_jpl_file(String)");
...
//#ifdef TRACE0
    System.out.println(System.currentTimeMillis()+" SwissEph.swe_set_sid_mode(int, double, double)");
    System.out.println("    sid_mode: " + sid_mode + "\n    t0: " + Trace.fmtDbl(t0) + "\n    ayan_t0: " + Trace.fmtDbl(ayan_t0));
//#endif /* TRACE0 */
...
//#ifdef TRACE0
    System.out.println(System.currentTimeMillis()+" SwissEph.swe_get_ayanamsa(double)");
    System.out.println("    tjd_et: " + Trace.fmtDbl(tjd_et));
//#endif /* TRACE0 */
...
//#ifdef TRACE0
    System.out.println(System.currentTimeMillis()+" SwissEph.swe_get_ayanamsa_ut(double)");
    System.out.println("    tjd_ut: " + Trace.fmtDbl(tjd_ut));
//#endif /* TRACE0 */
...
//#ifndef ASTROLOGY
  ...
  */
  public int swe_fixstar(StringBuffer star, double tjd, int iflag, double xx[],
                         StringBuffer serr) {
//#ifdef TRACE0
    System.out.println(System.currentTimeMillis()+" SwissEph.swe_fixstar(StringBuffer, double, int, double[], StringBuffer)");
...
//#ifdef TRACE0
    System.out.println(System.currentTimeMillis()+" SwissEph.swe_fixstar_ut(StringBuffer, double, int, double[], StringBuffer)");
...
//#ifdef TRACE0
    Trace.level++;
    Trace.trace(Trace.level, "SwissEph.swe_get_planet_name(int)");
//#ifdef TRACE1
...
//#ifdef TRACE0
    Trace.level++;
    Trace.trace(Trace.level, "SwissEph.swe_set_topo(double, double, double)");
//#ifdef TRACE1
    System.out.println("    geolon: " + Trace.fmtDbl(geolon) + "\n    geolat: " + Trace.fmtDbl(geolat) + "\n    geoalt: " + Trace.fmtDbl(geoalt));
//#endif /* TRACE1 */
//#endif /* TRACE0 */
...
//#ifdef TRACE0
    System.out.println(System.currentTimeMillis()+" SwissEph.getJPLRange(String)");
    System.out.println("    fname: " + fname);
//#endif /* TRACE0 */
    if (sj==null) {
...
//#ifndef NO_RISE_TRANS
  ...
  */
  public void swe_azalt(double tjd_ut, int calc_flag, double[] geopos,
                        ...
                        double[] xaz) {
//#ifdef TRACE0
    System.out.println(System.currentTimeMillis()+" SwissEph.swe_azalt(double, int, double[], double, double, double[], double[])");
    System.out.println("    tjd_ut: " + Trace.fmtDbl(tjd_ut) + "\n    calc_flag: " + calc_flag);
    Trace.printDblArr("geopos", geopos);
    System.out.println("    atpress: " + Trace.fmtDbl(atpress) + "\n    attemp: " + Trace.fmtDbl(attemp));
    Trace.printDblArr("xin", xin);
    Trace.printDblArr("xaz", xaz);
//#endif /* TRACE0 */
    if (sc==null) {
      sc=new Swecl(this, sl, sm, null, swed);
    }
...
//#ifdef TRACE0
    System.out.println(System.currentTimeMillis()+" SwissEph.swe_azalt_rev(double, int, double[], double[], double[])");
    System.out.println("    tjd_ut: " + Trace.fmtDbl(tjd_ut) + "\n    calc_flag: " + calc_flag);
    Trace.printDblArr("geopos", geopos);
    Trace.printDblArr("xin", xin);
    Trace.printDblArr("xout", xout);
//#endif /* TRACE0 */
    if (sc==null) {
      sc=new Swecl(this, sl, sm, null, swed);
    }
...
//#ifdef TRACE0
    System.out.println(System.currentTimeMillis()+" SwissEph.swe_lun_eclipse_how(double, int, double[], double[], StringBuffer)");
    System.out.println("    tjd_ut: " + Trace.fmtDbl(tjd_ut) + "\n    ifl: " + ifl);
    Trace.printDblArr("geopos", geopos);
    Trace.printDblArr("attr", attr);
    System.out.println("    serr: " + serr);
//#endif /* TRACE0 */
    if (sc==null) {
      sc=new Swecl(this, sl, sm, null, swed);
...
//#ifndef ASTROLOGY
  ...
  */
  public int swe_lun_eclipse_when(double tjd_start, int ifl, int ifltype,
                                  ...
                                  StringBuffer serr) {
//#ifdef TRACE0
    System.out.println(System.currentTimeMillis()+" SwissEph.swe_lun_eclipse_when(double, int, int, double[], int, StringBuffer)");
    System.out.println("    tjd_start: " + Trace.fmtDbl(tjd_start) + "\n    ifl: " + ifl + "\n    ifltype: " + ifltype);
    Trace.printDblArr("tret", tret);
...
//#ifndef ASTROLOGY
  ...
  */
  public int swe_nod_aps(double tjd_et, int ipl, int iflag, int  method,
                         ...
                         StringBuffer serr) {
//#ifdef TRACE0
    System.out.println(System.currentTimeMillis()+" SwissEph.swe_nod_aps(double, int, int, int, double[], double[], double[], double[], StringBuffer)");
    System.out.println("    tjd_et: " + Trace.fmtDbl(tjd_et) + "\n    ipl: " + ipl + "\n    iflag: " + iflag + "\n    method: " + method);
    Trace.printDblArr("xnasc", xnasc);
    Trace.printDblArr("xndsc", xndsc);
    Trace.printDblArr("xperi", xperi);
    Trace.printDblArr("xaphe", xaphe);
    System.out.println("    serr: " + serr);
//#endif /* TRACE0 */
    if (sc==null) {
      sc=new Swecl(this, sl, sm, null, swed);
...
//#ifndef ASTROLOGY
  ...
  */
  public int swe_nod_aps_ut(double tjd_ut, int ipl, int iflag, int  method,
                            ...
                            StringBuffer serr) {
//#ifdef TRACE0
    System.out.println(System.currentTimeMillis()+" SwissEph.swe_nod_aps_ut(double, int, int, int, double[], double[], double[], double[], StringBuffer)");
    System.out.println("    tjd_ut: " + Trace.fmtDbl(tjd_ut) + "\n    ipl: " + ipl + "\n    iflag: " + iflag + "\n    method: " + method);
    Trace.printDblArr("xnasc", xnasc);
    Trace.printDblArr("xndsc", xndsc);
    Trace.printDblArr("xperi", xperi);
...
//#ifndef ASTROLOGY
  ...
  */
  public int swe_pheno(double tjd, int ipl, int iflag, double[] attr,
                       StringBuffer serr) {
//#ifdef TRACE0
    System.out.println(System.currentTimeMillis()+" SwissEph.swe_pheno(double, int, int, double[], StringBuffer)");
    System.out.println("    tjd: " + Trace.fmtDbl(tjd) + "\n    ipl: " + ipl + "\n    iflag: " + iflag);
    Trace.printDblArr("attr", attr);
    System.out.println("    serr: " + serr);
//#endif /* TRACE0 */
...
//#ifndef ASTROLOGY
  ...
  */
  public int swe_pheno_ut(double tjd_ut, int ipl, int iflag, double[] attr,
                          StringBuffer serr) {
//#ifdef TRACE0
    System.out.println(System.currentTimeMillis()+" SwissEph.swe_pheno_ut(double, int, int, double[], StringBuffer)");
    System.out.println("    tjd_ut: " + Trace.fmtDbl(tjd_ut) + "\n    ipl: " + ipl + "\n    iflag: " + iflag);
    Trace.printDblArr("attr", attr);
    System.out.println("    serr: " + serr);
//#endif /* TRACE0 */
...
//#ifndef NO_RISE_TRANS
  ...
  */
  public double swe_refrac(double inalt, double atpress, double attemp,
                           int calc_flag) {
//#ifdef TRACE0
    System.out.println(System.currentTimeMillis()+" SwissEph.swe_refrac(double, double, double, int)");
    System.out.println("    inalt: " + Trace.fmtDbl(inalt) + "\n    atpress: " + Trace.fmtDbl(atpress) + "\n    attemp: " + Trace.fmtDbl(attemp) + "\n    calc_flag: " + calc_flag);
//#endif /* TRACE0 */
    if (sc==null) {
      sc=new Swecl(this, sl, sm, null, swed);
    }
...
//#ifndef NO_RISE_TRANS
  ...
  */
  public int swe_rise_trans(double tjd_ut, int ipl, StringBuffer starname,
                            ...
                            StringBuffer serr) {
//#ifdef TRACE0
    System.out.println(System.currentTimeMillis()+" SwissEph.swe_rise_trans(double, int, StringBuffer, int, int, double[], double, double, DblObj, StringBuffer)");
...
//#ifdef TRACE0
    System.out.println(System.currentTimeMillis()+" SwissEph.swe_rise_trans(double, int, StringBuffer, int, int, double[], double, double, double, DblObj, StringBuffer)");
    System.out.println("    tjd_ut: " + Trace.fmtDbl(tjd_ut) + "\n    ipl: " + ipl + "\n    starname: " + starname.toString() + "\n    epheflag: " + epheflag + "\n    rsmi: " + rsmi);
    Trace.printDblArr("geopos", geopos);
...
//#ifndef ASTROLOGY
  ...
  */
  public int swe_sol_eclipse_how(double tjd_ut, int ifl, double[] geopos,
                                 double[] attr, StringBuffer serr) {
//#ifdef TRACE0
    System.out.println(System.currentTimeMillis()+" SwissEph.swe_sol_eclipse_how(double, int, double[], double[], StringBuffer)");
    System.out.println("    tjd_ut: " + Trace.fmtDbl(tjd_ut) + "\n    ifl: " + ifl);
    Trace.printDblArr("geopos", geopos);
    Trace.printDblArr("attr", attr);
    System.out.println("    serr: " + serr);
...
//#ifndef ASTROLOGY
  ...
  */
  public int swe_sol_eclipse_when_glob(double tjd_start, int ifl, int ifltype,
                                       ...
                                       StringBuffer serr) {
//#ifdef TRACE0
    System.out.println(System.currentTimeMillis()+" SwissEph.swe_sol_eclipse_when_glob(double, int, int, double[], int, StringBuffer)");
    System.out.println("    tjd_start: " + Trace.fmtDbl(tjd_start) + "\n    ifl: " + ifl + "\n    ifltype: " + ifltype);
    Trace.printDblArr("tret", tret);
    System.out.println("    backward: " + backward + "\n    serr: " + serr);
//#endif /* TRACE0 */
...
//#ifndef ASTROLOGY
  ...
  */
  public int swe_sol_eclipse_when_loc(double tjd_start, int ifl,
                                      ...
                                      StringBuffer serr) {
//#ifdef TRACE0
    System.out.println(System.currentTimeMillis()+" SwissEph.swe_sol_eclipse_when_loc(double, int, double[], double[], double[], int, StringBuffer)");
    System.out.println("    tjd_start: " + Trace.fmtDbl(tjd_start) + "\n    ifl: " + ifl);
    Trace.printDblArr("geopos", geopos);
    Trace.printDblArr("tret", tret);
    Trace.printDblArr("attr", attr);
...
//#ifndef ASTROLOGY
  ...
  */
  public int swe_sol_eclipse_where(double tjd_ut, int ifl, double[] geopos,
                                   double[] attr, StringBuffer serr) {
//#ifdef TRACE0
    System.out.println(System.currentTimeMillis()+" SwissEph.swe_sol_eclipse_where(double, int, double[], double[], StringBuffer)");
    System.out.println("    tjd_ut: " + Trace.fmtDbl(tjd_ut) + "\n    ifl: " + ifl);
    Trace.printDblArr("geopos", geopos);
    Trace.printDblArr("attr", attr);
    System.out.println("    serr: " + serr);
...
//#ifdef TRACE0
    System.out.println(System.currentTimeMillis()+" SwissEph.swe_lun_occult_when_loc(double, int, StringBuffer, int, double[], double[], double[], int, StringBuffer)");
    System.out.println("    tjd_start: " + Trace.fmtDbl(tjd_start) + "\n    ipl: " + ipl + "\n    starname: " + starname.toString() + "\n    ifl: " + ifl);
    Trace.printDblArr("geopos", geopos);
    Trace.printDblArr("tret", tret);
    Trace.printDblArr("attr", attr);
...
//#ifndef ASTROLOGY
  ...
  */
  public int swe_lun_occult_where(double tjd_ut,
                                  ...
                                  StringBuffer serr) {
//#ifdef TRACE0
    System.out.println(System.currentTimeMillis()+" SwissEph.swe_lun_occult_where(double, int, StringBuffer, int, double[], double[], StringBuffer)");
    System.out.println("    tjd_ut: " + Trace.fmtDbl(tjd_ut) + "\n    ipl: " + ipl + "\n    starname: " + starname.toString() + "\n    ifl: " + ifl);
    Trace.printDblArr("geopos", geopos);
    Trace.printDblArr("attr", attr);
    System.out.println("    serr: " + serr);
...
//#ifdef TRACE0
    System.out.println(System.currentTimeMillis()+" SwissEph.swe_lun_occult_when_glob(double, int, StringBuffer, int, int, double[], int, StringBuffer)");
    System.out.println("    tjd_start: " + Trace.fmtDbl(tjd_start) + "\n    ipl: " + ipl + "\n    starname: " + starname.toString() + "\n    ifl: " + ifl + "\n    ifltype: " + ifltype);
    Trace.printDblArr("tret", tret);
    System.out.println("    backward: " + backward + "\n    serr: " + serr);
//#endif /* TRACE0 */
...
//#ifdef TRACE0
    System.out.println(System.currentTimeMillis()+" SwissEph.swe_gauquelin_sector(double, int, StringBuffer, int, int, double[], double, double, DblObj, StringBuffer)");
    System.out.println("    t_ut: " + Trace.fmtDbl(t_ut) + "\n    ipl: " + ipl + "\n    starname: " + starname.toString() + "\n    iflag: " + iflag + "\n    imeth: " + imeth);
    Trace.printDblArr("geopos", geopos);
...
//#ifdef TRACE0
    System.out.println(System.currentTimeMillis()+" SwissEph.swe_house_pos(double, double, double, int, double[], StringBuffer)");
    System.out.println("    armc: " + Trace.fmtDbl(armc) + "\n    geolat: " + Trace.fmtDbl(geolat) + "\n    eps: " + Trace.fmtDbl(eps) + "\n    hsys: " + hsys);
    Trace.printDblArr("xpin", xpin);
    System.out.println("    serr: " + serr);
//#endif /* TRACE0 */
    if (sh==null) {
...
//#ifdef TRACE0
    System.out.println(System.currentTimeMillis()+" SwissEph.swe_houses_armc(double, double, double, int, double[], double[])");
    System.out.println("    armc: " + Trace.fmtDbl(armc) + "\n    geolat: " + Trace.fmtDbl(geolat) + "\n    eps: " + Trace.fmtDbl(eps) + "\n    hsys: " + hsys);
    Trace.printDblArr("cusp", cusp);
    Trace.printDblArr("ascmc", ascmc);
//#endif /* TRACE0 */
    if (sh==null) {
      sh=new SweHouse(sl, this, swed);
    }
  ...
  */  
  public int swe_houses(double tjd_ut, int iflag, double geolat,
                        ...
                        double[] ascmc) {
//#ifdef TRACE0
    System.out.println(System.currentTimeMillis()+" SwissEph.swe_houses(double, int, double, double, int, double[], double[])");
...
//#ifdef TRACE0
    System.out.println(System.currentTimeMillis()+" SwissEph.swe_houses(double, int, double, double, int, double[], double[], int)");
    System.out.println("    tjd_ut: " + Trace.fmtDbl(tjd_ut) + "\n    iflag: " + iflag + "\n    geolat: " + Trace.fmtDbl(geolat) + "\n    geolon: " + Trace.fmtDbl(geolon) + "\n    hsys: " + hsys);
    Trace.printDblArr("cusp", cusp);
    Trace.printDblArr("ascmc", ascmc);
    System.out.println("    aOffs: " + aOffs);
//#endif /* TRACE0 */
    if (sh==null) {
      sh=new SweHouse(sl, this, swed);
    }
...
//#ifdef TEST_ITERATIONS
  /**
  * Returns the number of iterations of the last transit calculation. The transit
  * calculations calculate a planet position and proceed calculating the planets
  * positions until the maximum precision has been reached. This method returns
  * the amount of calculations performed.<p>
  * ATTENTION: This method is in NO WAY thread save and the count of iterations
  * is ONLY valid for the last transit calculation!
...
//#endif /* TEST_ITERATIONS */
  ...
  * @see swisseph.TCPlanetPlanet#TCPlanetPlanet(SwissEph, int, int, int, double)
  */
  public double getTransitUT(TransitCalculator tc, double jdUT, boolean backwards)
         throws IllegalArgumentException, SwissephException {
    if (ext==null) { ext=new Extensions(this); }
    return ext.getTransit(tc,
  ...
  * @see swisseph.TCPlanetPlanet#TCPlanetPlanet(SwissEph, int, int, int, double)
  */
  public double getTransitUT(TransitCalculator tc, double jdUT, boolean backwards, double jdLimit)
         throws IllegalArgumentException, SwissephException {
    if (ext==null) { ext=new Extensions(this); }
    return ext.getTransit(tc,
                          jdUT + SweDate.getDeltaT(jdUT),
...
//#ifdef TRACE0
    System.out.println(System.currentTimeMillis()+" SwissEph.swe_calc_error(double[])");
    Trace.printDblArr("xx", xx);
//#endif /* TRACE0 */
...
//#ifdef TRACE0
    Trace.level++;
    Trace.trace(Trace.level, "SwissEph.swecalc(double, int, int, double[], StringBuffer)");
//#ifdef TRACE1
    System.out.println("    tjd: " + Trace.fmtDbl(tjd) + "\n    ipl: " + ipl + "\n    iflag: " + iflag);
...
//#endif /* TRACE0 */
     ...
     **********************************************/
      ...
      xp = pedp.xreturn;
//#ifdef ASTROLOGY
System.err.println("BARYCENTRIC SUN requested!"); System.exit(1);
//#else
...
//#endif /* TRACE0 */
          ...
          retc = sj.swi_pleph(tjd, sj.J_SUN, sj.J_SBARY, psdp.x, serr);
...
//#ifdef ORIGINAL
                      cv.fmt("%8.1f",SwephData.CHIRON_START)+" - JD "+
                      cv.fmt("%8.1f",SwephData.CHIRON_END));
//#else
...
//#ifdef ORIGINAL
                     cv.fmt("%8.1f",SwephData.PHOLUS_START));
//#else
...
//#ifndef NO_MOSHIER
  int moshier_moon(double tjd, boolean do_save, double[] xpmret,
                                                         StringBuffer serr) {
//#ifdef TRACE0
    System.out.println(System.currentTimeMillis()+" SwissEph.moshier_moon(double, boolean, double[], StringBuffer)");
    System.out.println("    tjd: " + Trace.fmtDbl(tjd) + "\n    do_save: " + do_save);
    Trace.printDblArr("xpmret", xpmret);
    System.out.println("    serr: " + serr);
//#endif /* TRACE0 */
...
//#ifdef TRACE0
    System.out.println(System.currentTimeMillis()+" SwissEph.swecalc_error(double[])");
//#endif /* TRACE0 */
    /***********************************************
     * return error                                *
     ***********************************************/
...
//#ifndef ASTROLOGY
  int sweph_sbar(double tjd, int iflag, PlanData psdp, PlanData pedp,
                 StringBuffer serr) {
//#ifdef TRACE0
    System.out.println(System.currentTimeMillis()+" SwissEph.sweph_sbar(double, int, PlanData, PlanData, StringBuffer)");
    System.out.println("    tjd: " + Trace.fmtDbl(tjd) + "\n    iflag: " + iflag + "\n    psdp: " + psdp.toString() + "\n    serr: " + serr);
//#endif /* TRACE0 */
    int retc;
...
//#ifdef TRACE0
    System.out.println(System.currentTimeMillis()+" SwissEph.sweph_moon(double, int, int, StringBuffer)");
    System.out.println("    tjd: " + Trace.fmtDbl(tjd) + "\n    ipli: " + ipli + "\n    iflag: " + iflag + "\n    serr: " + serr);
//#endif /* TRACE0 */
    int retc;
//#if 0
...
//#ifdef TRACE0
    Trace.level++;
    Trace.trace(Trace.level, "SwissEph.calc_epsilon(double, Epsilon)");
//#ifdef TRACE1
    System.out.println("    tjd: " + Trace.fmtDbl(tjd) + "\n    e: " + e);
//#endif /* TRACE1 */
//#endif /* TRACE0 */
...
//#ifdef TRACE0
    Trace.level++;
    Trace.trace(Trace.level, "SwissEph.main_planet(double, int, int, int, StringBuffer)");
//#ifdef TRACE1
    System.out.println("    tjd: " + Trace.fmtDbl(tjd) + "\n    ipli: " + ipli + "\n    epheflag: " + epheflag + "\n    iflag: " + iflag + "\n    serr: " + serr);
//#endif /* TRACE1 */
//#endif /* TRACE0 */
...
//#ifndef ASTROLOGY
  ...
  int main_planet_bary(double tjd, int ipli, int epheflag, int iflag,
                       ...
                       StringBuffer serr) {
//#ifdef TRACE0
    System.out.println(System.currentTimeMillis()+" SwissEph.main_planet_bary(double, int, int, int, boolean, double[], double[], double[], double[], StringBuffer)");
    System.out.println("    tjd: " + Trace.fmtDbl(tjd) + "\n    ipli: " + ipli + "\n    epheflag: " + epheflag + "\n    iflag: " + iflag + "\n    do_save: " + do_save);
    Trace.printDblArr("xp", xp);
    Trace.printDblArr("xe", xe);
    Trace.printDblArr("xs", xs);
    Trace.printDblArr("xm", xm);
    System.out.println("    serr: " + serr);
//#endif /* TRACE0 */
//#ifndef NO_MOSHIER
    int i;
...
//#endif /* ASTROLOGY */
  ...
  int swemoon(double tjd, int iflag, boolean do_save, double xpret[],
              StringBuffer serr) {
//#ifdef TRACE0
    System.out.println(System.currentTimeMillis()+" SwissEph.swemoon(double, int, boolean, double[], StringBuffer)");
//#endif /* TRACE0 */
    int i, retc;
...
//#ifdef TRACE0
    Trace.level++;
    Trace.trace(Trace.level, "SwissEph.sweplan(double, int, int, int, boolean, double[], double[], double[], double[], StringBuffer)");
//#ifdef TRACE1
    System.out.println("    tjd: " + Trace.fmtDbl(tjd) + "\n    ipli: " + ipli + "\n    ifno: " + ifno + "\n    iflag: " + iflag + "\n    do_save: " + do_save);
    Trace.printDblArr("xpret", xpret);
    Trace.printDblArr("xperet", xperet);
    Trace.printDblArr("xpsret", xpsret);
    Trace.printDblArr("xpmret", xpmret);
    System.out.println("    serr: " + serr);
//#endif /* TRACE1 */
//#endif /* TRACE0 */
...
//#ifndef NO_JPL
  ...
  int jplplan(double tjd, int ipli, int iflag, boolean do_save,
              ...
              StringBuffer serr) throws SwissephException {
//#ifdef TRACE0
      System.out.println(System.currentTimeMillis()+" SwissEph.jplplan(double, int, int, boolean, double[], double[], double[], StringBuffer)");
//#endif /* TRACE0 */
    int i, retc;
    ...
    if (do_earth) {
      ...
      if (tjd != pedp.teval || tjd == 0) {
        retc = sj.swi_pleph(tjd, sj.J_EARTH, sj.J_SBARY, xpe, serr);
        if (retc != SweConst.OK) {
          sj.swi_close_jpl_file();
          swed.jpl_file_is_open = false;
          return retc;
    ...
    if (do_sunbary) {
      ...
      if (tjd != psdp.teval || tjd == 0) {
        retc = sj.swi_pleph(tjd, sj.J_SUN, sj.J_SBARY, xps, serr);
        if (retc != SweConst.OK) {
          sj.swi_close_jpl_file();
          swed.jpl_file_is_open = false;
          return retc;
...
//#ifdef TRACE0
    Trace.level++;
    Trace.trace(Trace.level, "SwissEph.sweph(double, int, int, int, double[], boolean, double[], StringBuffer)");
//#ifdef TRACE1
    System.out.println("    tjd: " + Trace.fmtDbl(tjd) + "\n    ipli: " + ipli + "\n    ifno: " + ifno + "\n    iflag: " + iflag);
    Trace.printDblArr("xsunb", xsunb);
    System.out.println("    do_save: " + do_save + "\n    iflag: " + iflag);
    Trace.printDblArr("xpret", xpret);
    System.out.println("    serr: " + serr);
//#endif /* TRACE1 */
//#endif /* TRACE0 */
...
//#endif /* TRACE0 */
    ...
    if (tjd < fdp.tfstart || tjd > fdp.tfend) {
      if (serr != null) {
        if (tjd < fdp.tfstart) {
//#ifdef ORIGINAL
          s="jd "+cv.fmt("%f",tjd)+" < Swiss Eph. lower limit "+
            cv.fmt("%f",fdp.tfstart)+";";
//#else
          s="jd "+tjd+" < Swiss Eph. lower limit "+fdp.tfstart+";";
//#endif /* ORIGINAL */
        } else {
//#ifdef ORIGINAL
          s="jd "+cv.fmt("%f",tjd)+" > Swiss Eph. upper limit "+
            cv.fmt("%f",fdp.tfend)+";";
//#else
...
//#endif /* TRACE0 */
    ...
    if (fdp.sweph_denum >= 403 && ipl < SwephData.SEI_ANYBODY) {
      sl.swi_IERS_FK5(xp, xp, 1);
      if (need_speed) {
        sl.swi_IERS_FK5(xp, 3, xp, 3, 1);
      }
    }
...
////#ifdef TRACE0
//    Trace.level++;
//    Trace.trace(Trace.level, "SwissEph.swi_fopen(int, String <" + fname + ">, String, StringBuffer)");
////#ifdef TRACE1
...
////#ifdef TRACE1
//    System.out.println("    fnamp: " + fnamp + "\n    ifno: " + ifno);
////#endif /* TRACE1 */
////#endif /* TRACE0 */
    Socket sk=null;
    try {
...
//#ifdef TRACE0
    Trace.level++;
    Trace.trace(Trace.level, "SwissEph.app_pos_etc_plan(int, int, int, StringBuffer)");
//#ifdef TRACE1
    System.out.println("    ipli: " + ipli + "\n    iflag: " + iflag + "\n    serr: " + serr);
//#endif /* TRACE1 */
//#endif /* TRACE0 */
...
//#ifndef NO_JPL
        case SweConst.SEFLG_JPLEPH:
          if (ibody == SwephData.IS_PLANET) {
            ...
            retc = sj.swi_pleph(t, ipl, sj.J_SBARY, xx, serr);
            if (retc != SweConst.OK) {
              sj.swi_close_jpl_file();
              swed.jpl_file_is_open = false;
            }
            ...
            /* first sun */
            retc = sj.swi_pleph(t, sj.J_SUN, sj.J_SBARY, xsun, serr);
            if (retc != SweConst.OK) {
              sj.swi_close_jpl_file();
              swed.jpl_file_is_open = false;
            }
...
//#endif /* TRACE0 */
          ...
          if ((iflag & SweConst.SEFLG_SPEED)!=0
            ...
            && (iflag & SweConst.SEFLG_BARYCTR)==0) {
            retc = sj.swi_pleph(t, sj.J_EARTH, sj.J_SBARY, xearth, serr);
            if (retc != SweConst.OK) {
              sj.swi_close_jpl_file();
              swed.jpl_file_is_open = false;
//#ifdef TRACE0
...
//#ifdef TRACE0
    Trace.level++;
    Trace.trace(Trace.level, "SwissEph.app_pos_rest(PlanData, int, double[], double[], Epsilon, StringBuffer)");
//#ifdef TRACE1
    System.out.println("    pdp: " + pdp + "\n    iflag: " + iflag);
    Trace.printDblArr("xx", xx);
    Trace.printDblArr("x2000", x2000);
...
//#ifdef ASTROLOGY
System.err.println("(SE_SIDBIT_ECL_T0!=0) unexpected!"); System.exit(1);
//#else
...
//#ifdef ASTROLOGY
System.err.println("SE_SIDBIT_SSY_PLANE!=0 unexpected!"); System.exit(1);
//#else
...
//#ifdef TRACE0
    System.out.println(System.currentTimeMillis()+" SwissEph.swi_trop_ra2sid_lon(double[], double[], double[], int, StringBuffer)");
//#endif /* TRACE0 */
  ...
  int swi_trop_ra2sid_lon(double[] xin, double[] xout, int xoOffs,
                          ...
                          StringBuffer serr) {
//#ifdef TRACE0
    System.out.println(System.currentTimeMillis()+" SwissEph.swi_trop_ra2sid_lon(double[], double[], int, double[], int, int, StringBuffer)");
//#endif /* TRACE0 */
  ...
  int swi_trop_ra2sid_lon_sosy(double[] xin, double[] xout, double[] xoutr,
                               int iflag, StringBuffer serr) {
//#ifdef TRACE0
    System.out.println(System.currentTimeMillis()+" SwissEph.swi_trop_ra2sid_lon_sosy(double[], double[], double[], int, StringBuffer)");
//#endif /* TRACE0 */
  ...
  int swi_trop_ra2sid_lon_sosy(double[] xin, double[] xout, int xoOffs,
                               ...
                               StringBuffer serr) {
//#ifdef TRACE0
    System.out.println(System.currentTimeMillis()+" SwissEph.swi_trop_ra2sid_lon_sosy(double[], double[], int, double[], int, int, StringBuffer)");
//#endif /* TRACE0 */
...
//#ifdef TRACE0
    System.out.println(System.currentTimeMillis()+" SwissEph.app_pos_etc_plan_osc(int, int, int, StringBuffer)");
//#endif /* TRACE0 */
    int i, j, niter, retc;
...
//#ifdef TRACE0
    Trace.level++;
    Trace.trace(Trace.level, "SwissEph.swi_precess_speed(double[], int, double, int)");
//#ifdef TRACE1
    Trace.printDblArr("xx", xx);
...
//#ifdef TRACE0
    Trace.level++;
    Trace.trace(Trace.level, "SwissEph.swi_nutate(double[], int, int, boolean)");
//#ifdef TRACE1
    Trace.printDblArr("xx", xx);
...
//#ifdef TRACE0
    Trace.level++;
    Trace.trace(Trace.level, "SwissEph.swi_aberr_light(double[], double[], int)");
//#ifdef TRACE1
    Trace.printDblArr("xx", xx);
    System.out.println("    xxOffs: " + xxOffs);
    Trace.printDblArr("xe", xe);
...
//#ifdef TRACE0
    Trace.level++;
    Trace.trace(Trace.level, "SwissEph.swi_deflect_light(double[], int, double, int)");
//#ifdef TRACE1
    Trace.printDblArr("xx", xx);
    System.out.println("    offs: " + offs + "\n    dt: " + Trace.fmtDbl(dt) + "\n    iflag: " + iflag);
//#endif /* TRACE1 */
...
//#ifdef TRACE0
    Trace.level++;
    Trace.trace(Trace.level, "SwissEph.app_pos_etc_sun(int, StringBuffer)");
//#ifdef TRACE1
    System.out.println("    iflag: " + iflag + "\n    serr: " + serr);
//#endif /* TRACE1 */
//#endif /* TRACE0 */
...
//#ifdef TRACE0
    System.out.println(System.currentTimeMillis()+" SwissEph.app_pos_etc_moon(int, StringBuffer)");
//#endif /* TRACE0 */
    int i;
    int flg1, flg2;
...
//#ifndef NO_JPL
        case SweConst.SEFLG_JPLEPH:
          retc = sj.swi_pleph(t, sj.J_MOON, sj.J_EARTH, xx, serr);
          if (retc == SweConst.OK) {
            retc = sj.swi_pleph(t, sj.J_EARTH, sj.J_SBARY, xe, serr);
          }
          if (retc == SweConst.OK && (iflag & SweConst.SEFLG_HELCTR)!=0) {
            retc = sj.swi_pleph(t, sj.J_SUN, sj.J_SBARY, xs, serr);
          }
          if (retc != SweConst.OK) {
            sj.swi_close_jpl_file();
            swed.jpl_file_is_open = false;
...
//#ifdef TRACE0
    System.out.println(System.currentTimeMillis()+" SwissEph.app_pos_etc_sbar(int, StringBuffer)");
//#endif /* TRACE0 */
    int i;
...
//#ifdef TRACE0
    System.out.println(System.currentTimeMillis()+" SwissEph.app_pos_etc_mean(int, int, StringBuffer)");
//#endif /* TRACE0 */
    int i;
    int flg1, flg2;
...
//#ifdef TRACE0
    Trace.level++;
    Trace.trace(Trace.level, "SwissEph.rot_back(int)");
//#ifdef TRACE1
    System.out.println("    ipli: " + ipli);
//#endif /* TRACE1 */
//#endif /* TRACE0 */
...
//#ifdef TRACE0
    Trace.level++;
    Trace.trace(Trace.level, "SwissEph.embofs(double[], int, double[], int)");
//#ifdef TRACE1
    Trace.printDblArr("xemb", xemb);
    System.out.println("    eOffs: " + eOffs);
    Trace.printDblArr("xmoon", xmoon);
    System.out.println("    mOffs: " + mOffs);
//#endif /* TRACE1 */
//#endif /* TRACE0 */
    int i;
    for (i = 0; i <= 2; i++) {
...
//#ifdef TRACE0
    Trace.level++;
    Trace.trace(Trace.level, "SwissEph.nut_matrix(Nut, Epsilon)");
//#ifdef TRACE1
...
//#ifdef TRACE0
    System.out.println(System.currentTimeMillis()+" SwissEph.lunar_osc_elem(double, int, int, StringBuffer)");
//#endif /* TRACE0 */
    int i, j, istart;
//#ifndef NO_JPL
...
//#ifndef NO_JPL
        case SweConst.SEFLG_JPLEPH:
          ...
          for (i = istart; i <= 2; i++) {
            ...
            retc = swi_plan_for_osc_elem(iflag, t, xpos[i]); /* retc is always ok */
...
//        if ((iflag & SweConst.SEFLG_TRUEPOS) == 0 && retc >= SweConst.OK) {
//          dt = Math.sqrt(square_sum(xpos[i])) * SweConst.AUNIT / SwephData.CLIGHT /
//                                                                    86400;
...
//#ifdef SID_TNODE_FROM_ECL_T0
      ...
      if ((iflag & SweConst.SEFLG_SIDEREAL)!=0) {
        /* to J2000 */
        sl.swi_precess(ndp.xreturn, 18, sip.t0, SwephData.J_TO_J2000);
        if ((iflag & SweConst.SEFLG_SPEED)!=0) {
          swi_precess_speed(ndp.xreturn, 21, sip.t0, SwephData.J_TO_J2000);
        }
        if ((iflag & SweConst.SEFLG_J2000)==0) {
          /* to tjd */
          sl.swi_precess(ndp.xreturn, 18, tjd, SwephData.J2000_TO_J);
          if ((iflag & SweConst.SEFLG_SPEED)!=0) {
            swi_precess_speed(ndp.xreturn, 21, tjd, SwephData.J2000_TO_J);
          }
        }
      }
//#endif
...
//#ifdef TRACE0
    System.out.println(System.currentTimeMillis()+" SwissEph.swi_plan_for_osc_elem(int, double, double[])");
    System.out.println("    iflag: " + iflag + "\n    tjd: " + Trace.fmtDbl(tjd));
    Trace.printDblArr("xx", xx);
//#endif /* TRACE0 */
    int i;
...
//#ifdef TRACE0
    System.out.println(System.currentTimeMillis()+" SwissEph.meff(double)");
...
//#ifdef TRACE0
    System.out.println(System.currentTimeMillis()+" SwissEph.denormalize_positions(double[], double[], double[])");
    Trace.printDblArr("x0", x0);
    Trace.printDblArr("x1", x1);
    Trace.printDblArr("x2", x2);
//#endif /* TRACE0 */
    int i;
...
//#ifdef TRACE0
    System.out.println(System.currentTimeMillis()+" SwissEph.calc_speed(double[], double[], double[], double)");
    Trace.printDblArr("x0", x0);
    Trace.printDblArr("x1", x1);
    Trace.printDblArr("x2", x2);
...
//#ifdef TRACE0
    Trace.level++;
    Trace.trace(Trace.level, "SwissEph.swi_check_ecliptic(double)");
//#ifdef TRACE1
    System.out.println("    tjd: " + Trace.fmtDbl(tjd));
//#endif /* TRACE1 */
//#endif /* TRACE0 */
...
//#ifdef TRACE0
    Trace.level++;
    Trace.trace(Trace.level, "SwissEph.swi_check_nutation(double, int)");
//#ifdef TRACE1
    System.out.println("    tjd: " + Trace.fmtDbl(tjd) + "\n    iflag: " + iflag);
//#endif /* TRACE1 */
//#endif /* TRACE0 */
...
//#ifdef TRACE0
    Trace.level++;
    Trace.trace(Trace.level, "SwissEph.plaus_iflag(int)");
//#ifdef TRACE1
    System.out.println("    iflag: " + iflag);
//#endif /* TRACE1 */
//#endif /* TRACE0 */
...
//#ifndef ASTROLOGY
  int swe_fixstar_found(StringBuffer serr, String s, StringBuffer star,
                        ...
                        double[] xx) {
//#ifdef TRACE0
    System.out.println(System.currentTimeMillis()+" SwissEph.swe_fixstar_found(StringBuffer, String, StringBuffer, double, int, int, double[])");
//#endif /* TRACE0 */
    double xpo[] = null;
...
//#ifdef TRACE0
    System.out.println(System.currentTimeMillis()+" SwissEph.swe_fixstar_error(double[], int)");
//#endif /* TRACE0 */
    for (int i = 0; i <= 5; i++) {
      xx[i] = 0;
    }
...
//#ifdef TRACE0
    Trace.level++;
    Trace.trace(Trace.level, "SwissEph.swi_force_app_pos_etc()");
//#endif /* TRACE0 */
    int i;
    for (i = 0; i < SwephData.SEI_NPLANETS; i++) {
...
//#endif /* TRACE0 */
  ...
  int swi_get_observer(double tjd, int iflag, boolean do_save, double xobs[],
                       StringBuffer serr) {
//#ifdef TRACE0
    System.out.println(System.currentTimeMillis()+" SwissEph.swi_get_observer(double, int, boolean, double, StringBuffer)");
//#endif /* TRACE0 */
    int i;
    ...
    xobs[3] = SwephData.EARTH_ROT_SPEED;            /* speed */
    xobs[4] = xobs[5] = 0;
...
//#ifdef TRACE0
    System.out.println(System.currentTimeMillis()+" SwissEph.swe_time_equ(double, DblObj, StringBuffer)");
    System.out.println("    tjd: " + Trace.fmtDbl(tjd) + "\n    E: " + E.val + "\n    serr: " + serr);
//#endif /* TRACE0 */
...
////#ifdef TRACE1
//    System.out.println("    r: " + Trace.fmtDbl(r) + "\n    m: " + Trace.fmtDbl(m));
////#endif /* TRACE1 */
////#endif /* TRACE0 */
    this.r=r; this.m=m;
////#ifdef TRACE0
