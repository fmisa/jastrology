...
//#ifdef TEST_ITERATIONS
  "       java Transits -pt -lon100 -b1/1/2004 -ilocen -f+jP12 -x0.001\n"+
  "       java Transits -pt -lon100 -b1/1/2004 -ilocen -f+jP12 -x1\n"+
  "       java Transits -pt -lon100 -b1/1/2004 -ilocen -f+jP12 -x10000\n"+
//#else
...
//#ifdef EXTPRECISION
        ...
        try {
          extPrecision = Double.parseDouble(argv[i].substring(2));
        } catch (NumberFormatException nf) {
          return invalidValue(argv[i],2);
        }
//#endif /* EXTPRECISION */
...
//#ifdef EXTPRECISION
      tc.setPrecisionFactor(extPrecision);
//#endif /* EXTPRECISION */
...
//#ifdef TEST_ITERATIONS
        if (withHeader) {
          System.out.println("Iterations:        " +
              (icm>0?nnof.format(icm)+" / ":"") +
              nnof.format(ic) +
              (icp>0?" / "+nnof.format(icp):""));
        }
//#endif /* TEST_ITERATIONS */
