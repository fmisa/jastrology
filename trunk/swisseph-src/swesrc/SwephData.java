...
//#if 0
  ...
  static final double SHANI_MAX_HELIO_LAT_SPEED = 1./0.;
// TOPO, SWI:   

  static final double SHANI_MIN_HELIO_LAT_SPEED = 1./0.;
// TOPO, SWI:   

  static final double SHANI_MAX_HELIO_LAT_ACCEL = 1./0.;
// TOPO, SWI:   

  static final double SHANI_MIN_HELIO_LAT_ACCEL = 1./0.;
// TOPO, SWI:   
//#endif /* 0 */
...
//#if 0
  ...
  static final double SHANI_MAX_HELIO_DIST_SPEED = 1./0.;
// HELIO, SWI:   

  static final double SHANI_MIN_HELIO_DIST_SPEED = 1./0.;
// HELIO, SWI:   

  static final double SHANI_MAX_HELIO_DIST_ACCEL = 1./0.;
// HELIO, SWI:   

  static final double SHANI_MIN_HELIO_DIST_ACCEL = 1./0.;
// HELIO, SWI:   
//#endif /* 0 */
...
//#if 0
  ...
  static final double URANUS_MAX_HELIO_LON_SPEED = 1./0.;
// HELIO, SWI:   

  static final double URANUS_MIN_HELIO_LON_SPEED = 1./0.;
// HELIO, SWI:   

  static final double URANUS_MAX_HELIO_LON_ACCEL = 1./0.;
// HELIO, SWI:   

  static final double URANUS_MIN_HELIO_LON_ACCEL = 1./0.;
// HELIO, SWI:   
//#endif /* 0 */
...
//#if 0
  ...
  static final double URANUS_MAX_HELIO_LAT_SPEED = 1./0.;
// HELIO, JPL:   

  static final double URANUS_MIN_HELIO_LAT_SPEED = 1./0.;
// HELIO, JPL:   

  static final double URANUS_MAX_HELIO_LAT_ACCEL = 1./0.;
// HELIO, JPL:   

  static final double URANUS_MIN_HELIO_LAT_ACCEL = 1./0.;
// HELIO, JPL:   
//#endif /* 0 */
...
//#if 0
  ...
  static final double URANUS_MAX_HELIO_DIST_SPEED = 1./0.;
// HELIO, SWI:   

  static final double URANUS_MIN_HELIO_DIST_SPEED = 1./0.;
// HELIO, SWI:   

  static final double URANUS_MAX_HELIO_DIST_ACCEL = 1./0.;
// HELIO, SWI:   

  static final double URANUS_MIN_HELIO_DIST_ACCEL = 1./0.;
// HELIO, SWI:   
//#endif /* 0 */
...
//#if 0
  ...
  static final double NEPTUNE_MAX_HELIO_LON_SPEED = 1./0.;
// HELIO, SWI:   

  static final double NEPTUNE_MIN_HELIO_LON_SPEED = 1./0.;
// HELIO, SWI:   

  static final double NEPTUNE_MAX_HELIO_LON_ACCEL = 1./0.;
// HELIO, SWI:   

  static final double NEPTUNE_MIN_HELIO_LON_ACCEL = 1./0.;
// HELIO, SWI:   
//#endif /* 0 */
...
//#if 0
  ...
  static final double NEPTUNE_MAX_HELIO_LAT_SPEED = 1./0.;
// HELIO, SWI:   

  static final double NEPTUNE_MIN_HELIO_LAT_SPEED = 1./0.;
// HELIO, SWI:   

  static final double NEPTUNE_MAX_HELIO_LAT_ACCEL = 1./0.;
// HELIO, SWI:   

  static final double NEPTUNE_MIN_HELIO_LAT_ACCEL = 1./0.;
// HELIO, SWI:   
//#endif /* 0 */
...
//#if 0
  ...
  static final double NEPTUNE_MAX_HELIO_DIST_SPEED = 1./0.;
// HELIO, SWI:   

  static final double NEPTUNE_MIN_HELIO_DIST_SPEED = 1./0.;
// HELIO, SWI:   

  static final double NEPTUNE_MAX_HELIO_DIST_ACCEL = 1./0.;
// HELIO, SWI:   

  static final double NEPTUNE_MIN_HELIO_DIST_ACCEL = 1./0.;
// HELIO, SWI:   
//#endif /* 0 */
...
//#if 0
  ...
  static final double PLUTO_MAX_HELIO_LON_SPEED = 1./0.;
// HELIO, SWI:   

  static final double PLUTO_MIN_HELIO_LON_SPEED = 1./0.;
// HELIO, SWI:   

  static final double PLUTO_MAX_HELIO_LON_ACCEL = 1./0.;
// HELIO, JPL:   

  static final double PLUTO_MIN_HELIO_LON_ACCEL = 1./0.;
// HELIO, SWI:   
//#endif /* 0 */
...
//#if 0
  ...
  static final double PLUTO_MAX_HELIO_LAT_SPEED = 1./0.;
// HELIO, SWI:   

  static final double PLUTO_MIN_HELIO_LAT_SPEED = 1./0.;
// HELIO, SWI:   

  static final double PLUTO_MAX_HELIO_LAT_ACCEL = 1./0.;
// HELIO, SWI:   

  static final double PLUTO_MIN_HELIO_LAT_ACCEL = 1./0.;
// HELIO, SWI:   
//#endif /* 0 */
...
//#if 0
  ...
  static final double PLUTO_MAX_HELIO_DIST_SPEED = 1./0.;
// HELIO, SWI:   

  static final double PLUTO_MIN_HELIO_DIST_SPEED = 1./0.;
// HELIO, SWI:   

  static final double PLUTO_MAX_HELIO_DIST_ACCEL = 1./0.;
// HELIO, SWI:   

  static final double PLUTO_MIN_HELIO_DIST_ACCEL = 1./0.;
// HELIO, SWI:   
//#endif /* 0 */
...
//#if 0
  ...
  static final double CHIRON_MAX_HELIO_LON_SPEED = 1./0.;
// HELIO, SWI:   

  static final double CHIRON_MIN_HELIO_LON_SPEED = 1./0.;
// HELIO, SWI:   

  static final double CHIRON_MAX_HELIO_LON_ACCEL = 1./0.;
// HELIO, SWI:   

  static final double CHIRON_MIN_HELIO_LON_ACCEL = 1./0.;
// HELIO, SWI:   
//#endif /* 0 */
...
//#if 0
  ...
  static final double CHIRON_MAX_HELIO_LAT_SPEED = 1./0.;
// HELIO, SWI:   

  static final double CHIRON_MIN_HELIO_LAT_SPEED = 1./0.;
// HELIO, SWI:   

  static final double CHIRON_MAX_HELIO_LAT_ACCEL = 1./0.;
// HELIO, SWI:   

  static final double CHIRON_MIN_HELIO_LAT_ACCEL = 1./0.;
// HELIO, SWI:   
//#endif /* 0 */
...
//#if 0
  ...
  static final double CHIRON_MAX_HELIO_DIST_SPEED = 1./0.;
// HELIO, SWI:   

  static final double CHIRON_MIN_HELIO_DIST_SPEED = 1./0.;
// HELIO, SWI:   

  static final double CHIRON_MAX_HELIO_DIST_ACCEL = 1./0.;
// HELIO, SWI:   

  static final double CHIRON_MIN_HELIO_DIST_ACCEL = 1./0.;
// HELIO, SWI:   
//#endif /* 0 */
...
//#if 0
  ...
  static final double PHOLUS_MAX_HELIO_LON_SPEED = 1./0.;
// HELIO, SWI:   

  static final double PHOLUS_MIN_HELIO_LON_SPEED = 1./0.;
// HELIO, SWI:   

  static final double PHOLUS_MAX_HELIO_LON_ACCEL = 1./0.;
// HELIO, SWI:   

  static final double PHOLUS_MIN_HELIO_LON_ACCEL = 1./0.;
// HELIO, SWI:   
//#endif /* 0 */
...
//#if 0
  ...
  static final double PHOLUS_MAX_HELIO_LAT_SPEED = 1./0.;
// HELIO, SWI:   

  static final double PHOLUS_MIN_HELIO_LAT_SPEED = 1./0.;
// HELIO, SWI:   

  static final double PHOLUS_MAX_HELIO_LAT_ACCEL = 1./0.;
// HELIO, SWI:   

  static final double PHOLUS_MIN_HELIO_LAT_ACCEL = 1./0.;
// HELIO, SWI:   
//#endif /* 0 */
...
//#if 0
  ...
  static final double PHOLUS_MAX_HELIO_DIST_SPEED = 1./0.;
// HELIO, SWI:   

  static final double PHOLUS_MIN_HELIO_DIST_SPEED = 1./0.;
// HELIO, SWI:   

  static final double PHOLUS_MAX_HELIO_DIST_ACCEL = 1./0.;
// HELIO, SWI:   

  static final double PHOLUS_MIN_HELIO_DIST_ACCEL = 1./0.;
// HELIO, SWI:   
//#endif /* 0 */
...
//#if 0
  static final double CERES_MAX_HELIO_LON_SPEED = 1./0.;
// HELIO, SWI:   

  static final double CERES_MIN_HELIO_LON_SPEED = 1./0.;
// HELIO, SWI:   

  static final double CERES_MAX_HELIO_LON_ACCEL = 1./0.;
// HELIO, SWI:   

  static final double CERES_MIN_HELIO_LON_ACCEL = 1./0.;
// HELIO, SWI:   
//#endif /* 0 */
...
//#if 0
  ...
  static final double CERES_MAX_HELIO_LAT_SPEED = 1./0.;
// HELIO, SWI:   

  static final double CERES_MIN_HELIO_LAT_SPEED = 1./0.;
// HELIO, SWI:   

  static final double CERES_MAX_HELIO_LAT_ACCEL = 1./0.;
// HELIO, SWI:   

  static final double CERES_MIN_HELIO_LAT_ACCEL = 1./0.;
// HELIO, SWI:   
//#endif /* 0 */
...
//#if 0
  ...
  static final double CERES_MAX_HELIO_DIST_SPEED = 1./0.;
// HELIO, SWI:   

  static final double CERES_MIN_HELIO_DIST_SPEED = 1./0.;
// HELIO, SWI:   

  static final double CERES_MAX_HELIO_DIST_ACCEL = 1./0.;
// HELIO, SWI:   

  static final double CERES_MIN_HELIO_DIST_ACCEL = 1./0.;
// HELIO, SWI:   
//#endif /* 0 */
...
//#if 0
  ...
  static final double PALLAS_MAX_HELIO_LON_SPEED = 1./0.;
// HELIO, SWI:   

  static final double PALLAS_MIN_HELIO_LON_SPEED = 1./0.;
// HELIO, SWI:   

  static final double PALLAS_MAX_HELIO_LON_ACCEL = 1./0.;
// HELIO, SWI:   

  static final double PALLAS_MIN_HELIO_LON_ACCEL = 1./0.;
// HELIO, SWI:   
//#endif /* 0 */
...
//#if 0
  ...
  static final double PALLAS_MAX_HELIO_LAT_SPEED = 1./0.;
// HELIO, SWI:   

  static final double PALLAS_MIN_HELIO_LAT_SPEED = 1./0.;
// HELIO, SWI:   

  static final double PALLAS_MAX_HELIO_LAT_ACCEL = 1./0.;
// HELIO, SWI:   

  static final double PALLAS_MIN_HELIO_LAT_ACCEL = 1./0.;
// HELIO, SWI:   
//#endif /* 0 */
...
//#if 0
  ...
  static final double PALLAS_MAX_HELIO_DIST_SPEED = 1./0.;
// HELIO, SWI:   

  static final double PALLAS_MIN_HELIO_DIST_SPEED = 1./0.;
// HELIO, SWI:   

  static final double PALLAS_MAX_HELIO_DIST_ACCEL = 1./0.;
// HELIO, SWI:   

  static final double PALLAS_MIN_HELIO_DIST_ACCEL = 1./0.;
// HELIO, SWI:   
//#endif /* 0 */
...
//#if 0
  ...
  static final double JUNO_MAX_HELIO_LON_SPEED = 1./0.;
// HELIO, SWI:   

  static final double JUNO_MIN_HELIO_LON_SPEED = 1./0.;
// HELIO, SWI:   

  static final double JUNO_MAX_HELIO_LON_ACCEL = 1./0.;
// HELIO, SWI:   

  static final double JUNO_MIN_HELIO_LON_ACCEL = 1./0.;
// HELIO, SWI:   
//#endif /* 0 */
...
//#if 0
  ...
  static final double JUNO_MAX_HELIO_LAT_SPEED = 1./0.;
// HELIO, SWI:   

  static final double JUNO_MIN_HELIO_LAT_SPEED = 1./0.;
// HELIO, SWI:   

  static final double JUNO_MAX_HELIO_LAT_ACCEL = 1./0.;
// HELIO, SWI:   

  static final double JUNO_MIN_HELIO_LAT_ACCEL = 1./0.;
// HELIO, SWI:   
//#endif /* 0 */
...
//#if 0
  ...
  static final double JUNO_MAX_HELIO_DIST_SPEED = 1./0.;
// HELIO, SWI:   

  static final double JUNO_MIN_HELIO_DIST_SPEED = 1./0.;
// HELIO, SWI:   

  static final double JUNO_MAX_HELIO_DIST_ACCEL = 1./0.;
// HELIO, SWI:   

  static final double JUNO_MIN_HELIO_DIST_ACCEL = 1./0.;
// HELIO, SWI:   
//#endif /* 0 */
...
//#if 0
  ...
  static final double VESTA_MAX_HELIO_LON_SPEED = 1./0.;
// HELIO, SWI:   

  static final double VESTA_MIN_HELIO_LON_SPEED = 1./0.;
// HELIO, SWI:   

  static final double VESTA_MAX_HELIO_LON_ACCEL = 1./0.;
// HELIO, SWI:   

  static final double VESTA_MIN_HELIO_LON_ACCEL = 1./0.;
// HELIO, SWI:   
//#endif /* 0 */
...
//#if 0
  ...
  static final double VESTA_MAX_HELIO_LAT_SPEED = 1./0.;
// HELIO, SWI:   

  static final double VESTA_MIN_HELIO_LAT_SPEED = 1./0.;
// HELIO, SWI:   

  static final double VESTA_MAX_HELIO_LAT_ACCEL = 1./0.;
// HELIO, SWI:   

  static final double VESTA_MIN_HELIO_LAT_ACCEL = 1./0.;
// HELIO, SWI:   
//#endif /* 0 */
...
//#if 0
  ...
  static final double VESTA_MAX_HELIO_DIST_SPEED = 1./0.;
// HELIO, SWI:   

  static final double VESTA_MIN_HELIO_DIST_SPEED = 1./0.;
// HELIO, SWI:   

  static final double VESTA_MAX_HELIO_DIST_ACCEL = 1./0.;
// HELIO, SWI:   

  static final double VESTA_MIN_HELIO_DIST_ACCEL = 1./0.;
// HELIO, SWI:   
//#endif /* 0 */
