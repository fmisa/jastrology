...
double minVal = 0., maxVal = 0.;  // Thinking about it...
  ...
  * up to SweConst.SE_VESTA with the exception of SweConst.SE_EARTH.
  ...
  * SweConst.SEFLG_TOPOCTR and SweConst.SEFLG_SIDEREAL, plus the ephemeris
  * flags SweConst.SEFLG_MOSEPH, SweConst.SEFLG_SWIEPH or SweConst.SEFLG_JPLEPH
  * optionally.
